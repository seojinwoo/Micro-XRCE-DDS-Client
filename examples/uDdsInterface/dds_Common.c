...
bool CommonResponse_serialize_topic(ucdrBuffer* writer, const CommonResponse* topic)
{
    bool success = true;
...
bool CommonResponse_deserialize_topic(ucdrBuffer* reader, CommonResponse* topic)
{
    bool success = true;
