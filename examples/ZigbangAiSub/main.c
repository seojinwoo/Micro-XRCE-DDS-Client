        ...
        char** argv)
{
    ...
    printf("UXR_CONFIG_UDP_TRANSPORT_MTU: %d#1 \n", UXR_CONFIG_UDP_TRANSPORT_MTU);
    // Streams
    ...
    uint16_t subscriber_req = uxr_buffer_create_subscriber_xml(&session, reliable_out, subscriber_id, participant_id,
                    subscriber_xml, UXR_REPLACE | UXR_REUSE);
